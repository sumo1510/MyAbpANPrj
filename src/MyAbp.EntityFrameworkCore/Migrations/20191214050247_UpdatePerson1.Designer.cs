...
namespace MyAbp.Migrations
{
    ...
    [Migration("20191214050247_UpdatePerson1")]
    partial class UpdatePerson1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyAbp.Entitys.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MyAbp.Entitys.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MyAbp.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MyAbp.Authorization.Users.User", null)
                        .WithMany("Claims")
